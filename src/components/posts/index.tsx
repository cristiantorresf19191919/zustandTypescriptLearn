  ...
  return (
    ...
    <div className="header">
        {name} 
            ...
            {showMenu ? (
            <>
            <div className="icon" onClick={switchOpenMenu}>&and; </div>
            </>
        ) : (
            <>
            <div className="icon" onClick={switchOpenMenu}>&or; </div>
        ...
        transform: showMenu ? 'scale(1) translateX(0)' : 'scale(0.89) translateX(20px)',
        position: 'absolute',
        zIndex: 50,
        background: 'white',
